...
@Data
@Entity
@Table(name = "STD_NOTAS")
@SequenceGenerator(name = "SEQ_STD_NOTAS", sequenceName = "SEQ_STD_NOTAS", allocationSize = 1, initialValue= 1)
public class Notas {
    
	@Id
    @Column(name = "stdn_id")
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_STD_NOTAS") 
	@JsonProperty
    private Integer id;
    ...
    public String getFechaModificaFormato() {
        String fecha = "";
        String hora = "";
