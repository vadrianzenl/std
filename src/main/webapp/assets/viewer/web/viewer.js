...
function getViewerConfiguration() {
  return {
    ...
    secondaryToolbar: {
      ...
      digitalSignatureValidateButton: document.getElementById('secondaryDigitalSignatureValidate')
    },
    fullscreen: {
...
var PDFViewerApplication = {
  ...
  bindEvents: function bindEvents() {
    ...
    eventBus.on("digitalSignatureValidate", webViewerDigitalSignatureValidate);
  },
  ...
  unbindEvents: function unbindEvents() {
    ...
    eventBus.off("digitalSignatureValidate", webViewerDigitalSignatureValidate);
...
var validateFileURL;
{
  var HOSTED_VIEWER_ORIGINS = ["null", "http://mozilla.github.io", "https://mozilla.github.io", "http://localhost:8888", "http://localhost:8080", "https://localhost:8443", "https://svr-appdesa.congreso.net", "https://svr-apptest.congreso.net", "https://svr-appserver.congreso.net", "http://svr-appdesa.congreso.net", "http://svr-apptest.congreso.net", "http://svr-appserver.congreso.net", "http//congreso.gob.pe", "https//congreso.gob.pe"];
  console.log('HOSTED_VIEWER_ORIGINS', HOSTED_VIEWER_ORIGINS);

  validateFileURL = function validateFileURL(file) {
    console.log('validateFileURL', 'file', file);
    ...
    try {
      ...
      console.log('validateFileURL', 'viewerOrigin', viewerOrigin, window.location.href);
...
function webViewerDigitalSignatureValidate(evt) {
  console.log("webViewerDigitalSignatureValidate", evt, PDFViewerApplication);
  alert("Validando firma digital");
}
...
var defaultOptions = {
  ...
  workerSrc: {
    value: 'assets/viewer/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
function () {
  function Toolbar(options, eventBus) {
    ...
    this.buttons = [{
      ...
      element: options.digitalSignatureValidate,
      eventName: 'digitalSignatureValidate'
    }];
    this.items = {
