...
<!--STD | DV | 2019-11-25-->
<link rel="stylesheet" href="assets/viewer/web/viewer.css" />
...
<!-- STD | DV | 2019-11-25 -->
<link rel="resource" type="application/l10n" href="assets/viewer/web/locale/locale.properties">
<script src="assets/viewer/build/pdf.js"></script>
...
<!-- STD | DV | 2019-11-25 -->
<!-- This snippet is used in production (included from viewer.html) -->
<script src="assets/viewer/web/viewer.js"></script>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                <!-- <button
                  id="digitalSignatureValidate"
                  class="toolbarButton digitalSignature validate "
                  title="Validate Digital Signature"
                  tabindex="32"
                  data-l10n-id="digital_signature_validate"
                >
                  <span data-l10n-id="digital_signature_validate_label"
                    >Digital Signature Validate</span
                  >
                </button> -->
